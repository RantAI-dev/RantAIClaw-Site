...
L2 is the recommended starting default. See [Autonomy Levels](/docs/concepts/autonomy-levels) for the full mechanics — the runtime enum has only three values (`read_only`, `supervised`, `full`); the L1–L4 names are preset bundles the wizard writes.
