...
| `approval/` | Approval gate (CLI prompt, session-scoped allowlist), Manual / Smart / Strict / Off preset writer |
...
- [Autonomy Levels](/docs/concepts/autonomy-levels) — the 3-level runtime enum and the Manual / Smart / Strict / Off preset bundles
...
- [Security Model](/docs/concepts/security) — the deny-by-default boundaries
